...
public class PainelControle{
	...
	private static final String[]       GABARITO													= new String[]{
		"[arq]", "Gabarito de um dado esperado para o endereco"
	};
	...
	/*** Mensagem: Informe o dado final */
	private static final String			MSG_INFORME_DADO					= "Informe o dado a ser comparado [%4H]: ";
	 ...
	 *           caso ocorra algum erro de execuçăo
	 */
	private void comparaDados(String args) throws MVNException{
